...
class RankControllerTest {
  ...
  void topFreqActivities() {
    ...
    Set<Map.Entry<String, Double>> result = new HashSet<>(rankController.topFreqActivities());
  ...
  void topCaloriesActivities() {
    ...
    Set<Map.Entry<String, Double>> result = new HashSet<>(
        rankController.topCaloriesActivities());
